...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/theme/css/datatables/tools/css/dataTables.tableTools.css" rel="stylesheet">
...
<body class="nav-md">
    ...
    <div class="container body">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="<?php echo base_url() ?>assets/theme/images/img.jpg" alt="..." class="img-circle profile_img">
                        </div>
        ...
        <!-- chart js -->
        <script src="<?php echo base_url() ?>assets/theme/js/chartjs/chart.min.js"></script>
        ...
        <script src="<?php echo base_url() ?>assets/theme/js/custom.js"></script>
            ...
            <!-- form validation -->
             <script src="<?php echo base_url() ?>assets/theme/js/tags/jquery.tagsinput.min.js"></script>
            <script type="<?php echo base_url() ?>assets/theme/text/javascript" src="js/parsley/parsley.min.js"></script> 
            <!-- daterangepicker -->
            <script type="text/javascript" src="<?php echo base_url() ?>assets/theme/js/moment.min2.js"></script>
        ...
        <!-- Datatables -->
        <script src="<?php echo base_url() ?>assets/theme/js/datatables/js/jquery.dataTables.js"></script>
        <script src="<?php echo base_url() ?>assets/theme/js/datatables/tools/js/dataTables.tableTools.js"></script>
        <script>
